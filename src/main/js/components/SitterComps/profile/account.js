        ...
        return (
                <div className="row">
                        <div className="col-md-2 hidden-xs" align="center">
                              <Image src="https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909_960_720.png" responsive />
                            <div>
                                <label >
